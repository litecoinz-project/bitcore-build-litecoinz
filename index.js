...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-litecoinz/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-litecoinz -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-litecoinz -o bitcore-lib-litecoinz.js';
    }
